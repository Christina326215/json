...
public class RestTemplateController {
    ...
    public String getForObject(){
        ...
        Student student = restTemplate.getForObject(
                "https://mocki.io/v1/6f2082c3-3e91-417d-a1a3-84b1be82365b",
                Student.class
        );
    ...
    public String getForObjectWithParam(){
        ...
        Student student = restTemplate.getForObject("https://mocki.io/v1/6f2082c3-3e91-417d-a1a3-84b1be82365b",
                Student.class,
                queryParamMap
        );
